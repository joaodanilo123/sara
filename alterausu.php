...
<html lang="en">
  ...
  <body class="bg-light">
    <?php
      ...
      $query = "SELECT id_usua, id_tipo_usua, senha, email, nome, sobrenome, user FROM usuarios WHERE id_usua='$id'";
    ...
    <div class="container">
      <div class="py-5 text-center">
        ...
        <h2>Altere um Usuário</h2>
      </div>
        <center>
        <div class="col-md-8 order-md-1">
          <form class="needs-validation" action="alterarusu.php" method="post" novalidate>
            <div class="row">
            ...
            <div class="d-block my-3">
              <div class="custom-control custom-radio">
                <input id="prof" name="tipou" type="radio" class="custom-control-input" value="1" required <?php echo ($row['id_tipo_usua'] == '1')?'checked':'';?>>
                <label class="custom-control-label" for="prof">Professor</label>
              </div>
              <div class="custom-control custom-radio">
                <input id="adm" name="tipou" type="radio" class="custom-control-input" value="2" required <?php echo ($row['id_tipo_usua'] == '2')?'checked':'';?>>
                <label class="custom-control-label" for="adm">Administrador</label>
              </div>
              <div class="custom-control custom-radio">
                <input id="ap" name="tipou" type="radio" class="custom-control-input" value="3" required <?php echo ($row['id_tipo_usua'] == '3')?'checked':'';?>>
